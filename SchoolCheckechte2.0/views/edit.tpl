...
<table>
       <tr>
            <td>id<input type="text" class="textField" placeholder="id" name="id" value="{$result.0.id}" readonly></td>
              
        <tr>
            <td>name<input type="text" class="textField" placeholder="Schoolname" name="name" value="{$result.0.name}" required></td>
        </tr>
        <tr>
